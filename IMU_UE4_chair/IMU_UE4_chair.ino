...
bool bidire_check = true;
bool bidireMode_check = false;
bool available_check = false;
long int Buffer;

bool check_start = true;
double offset_val = 0;
double accelX, accelY, accelZ, gyroZ;
double x,y,z;
...
{ 
    if(Serial.available()>0){
      ...
      if(Cpp_input.equals("T")){
        bidireMode_check = !bidireMode_check;
  ...
  if(y >1.5  && (f3 <= 10000 && f4 <= 10000) && abs(gyroZ)<3){ // backward
  ...
  else if(y < -1.5 && (f3 <= 10000 && f4 <= 10000)  && abs(gyroZ)<3) { // forward
    direct = 200001; 
    available_check = true;
    if((y) < -7){
      y = -7;
    ...
    y *= 100; // multiplied by 100 since the map() function uses integer math.
    printVal = map(y, 0, 700, 0, 100);
    printVal2 = map(f3, 0, 25000, 0, 100);
    bidire_check = true;
  }
  else if(y > 1.5 && f4 > 10000){ // B&R
      direct = 200008;
    bidire_check = true;
    available_check = true;
    f4 -= 10000;
    ...
    y *= 100; // multiplied by 100 since the map() function uses integer math.
    printVal = map(y, 0, 700, 0, 100);
    printVal2 = map(f4, 0, 25000, 0, 100);
    bidire_check = true;
  }
  else if(y < -1.5 && f3 > 10000){ // F&L
    direct = 200005;
    bidire_check = true;
    available_check = true;
    f3 -= 10000;
  ...
  else if(f3 > 10000){ // left
    direct = 200003;//1952867692;
    available_check = true;
    f3 -= 10000;
    printVal = map(f3, 0, 25000, 0, 100);
    bidire_check = false;
  }
  else if(f4 > 10000){ //right
    direct = 200004;
    available_check = true;
    f4 -= 10000;
    printVal = map(f4, 0, 25000, 0, 100);
    bidire_check = false;
  }
  ...
  if(bidireMode_check == true && bidire_check == true){
    byte Buffer[] = {
      byte(printVal2 & 0xff),
...
//    gyroZ = myICM.gyrZ();
//   
//    y = 90-(RAD_TO_DEG * (atan2(-accelX, -accelZ)+PI));  
//    z= -RAD_TO_DEG * (atan2(-accelY, -accelX)+PI);
//    if(check_start){
//      offset_val = y;
//      check_start = false;
//    }  
//    y -= offset_val; // subtract the offset (the original value)
//
//  if(y >2  && (f3 <= 6000 && f4 <= 6000) && abs(gyroZ)<3){ // backward
//    direct = 200002;
//    available_check = true;
//    if((y) > 7.5){
//      y = 7.5;
//    }
//    y *= 100; // multiplied by 100 since the map() function uses integer math.
//    printVal = map(y, 0, 750, 0, 100);
//  }
//  else if(y < -2 && (f3 <= 6000 && f4 <= 6000) && abs(gyroZ)<3) { // forward
//    direct = 200001; 
//    available_check = true;
//    if((y) < -7.5){
//      y = -7.5;
//    }
//    y *= 100; // multiplied by 100 since the map() function uses integer math.
//    printVal = map((-1.0*y), 0, 750, 0, 100);
//  }
//  else if(y > 2 && f3 > 6000){ // B&L
//    direct = 200006;
//    bidire_check = true;
//    available_check = true;
//    if((y) > 7.5){
...
//    printVal = map(y, 0, 750, 0, 100);
//    f3 -= 6000;
//    printVal2 = map(f3, 0, 64000, 0, 100);
//  }
//  else if(y > 2 && f4 > 6000){ // B&R
//    direct = 200008;
//    bidire_check = true;
//    available_check = true;
//    if((y) > 7.5){
...
//    printVal = map(y, 0, 750, 0, 100);
//    f4 -= 6000;
//    printVal2 = map(f4, 0, 64000, 0, 100);
//  }
//  else if(y < -2 && f3 > 6000){ // F&L
//    direct = 200005;
//    bidire_check = true;
//    available_check = true;
//    if((y) < -7.5){
...
//    printVal2 = map(f4, 0, 64000, 0, 100);
//  }
//  else if(f3 > 6000){ // left
//    direct = 200003;//1952867692;
//    available_check = true;
//    f3 -= 6000;
//    printVal = map(f3, 0, 64000, 0, 100);
//  }
//  else if(f4 > 6000){ //right
//    direct = 200004;
//    available_check = true;
//    f4 -= 6000;
//    printVal = map(f4, 0, 64000, 0, 100);
//  }
//  if(available_check == true){
//    byte Buffer2[] = {
//      byte(direct & 0xff),
