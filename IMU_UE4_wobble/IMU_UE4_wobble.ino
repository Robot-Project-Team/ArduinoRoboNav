...
//    }  
//    x -= offset_valX;
//    y -= offset_valY; // subtract the offset (the original value)
//    if(!bidireMode_check){
//      if(abs(x)>abs(y)){
//        y = 0;
//      }
...
//    printVal = map(y, 0, 12000, 0, 100);
//    bidire_check = false;
//  }
//  else if(y < -3 && (x <3 && x>-3)) { // forward
//    direct = 200001; 
//    available_check = true;
//    if((y) < -18){
//      y = -18;
//    }
//    y *= 100; // multiplied by 100 since the map() function uses integer math.
//    printVal = map((-1.0*y), 0, 12000, 0, 100);
//    bidire_check = false;
//  }
//  else if(y < -3 && x > 3){ // F&L
//    direct = 200005;
...
//    y *= 100; // multiplied by 100 since the map() function uses integer math.
//    printVal = map((-1.0*y), 0, 12000, 0, 100);
//    printVal2 = map((-1.0*x), 0, 7200, 0, 100);
//    bidire_check = true;
//  }
//  else if(y > 3 && x > 3){ // B&L
//    direct = 200006;
...
//    }
//    x *= 100;
//    printVal = map((-1.0*x), 0, 7200, 0, 100);
//    bidire_check = false;
//  }
